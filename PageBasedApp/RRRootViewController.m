...
@property (readonly, strong, nonatomic) RRModelController *modelController;
@end
...
- (RRModelController *)modelController
{
     // Return the model controller object, creating it if necessary.
     // In more complex implementations, the model controller may be passed to the view controller.
    if (!_modelController) {
        _modelController = [[RRModelController alloc] init];
    }
...
- (UIPageViewControllerSpineLocation)pageViewController:(UIPageViewController *)pageViewController spineLocationForInterfaceOrientation:(UIInterfaceOrientation)orientation
{
	...
	RRDataViewController *currentViewController = self.pageViewController.viewControllers[0];
