...
{   
    ...
    RRDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"RRDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(RRDataViewController *)viewController];
